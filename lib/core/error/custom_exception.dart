...
import 'package:bs_flutter_project_task/core/snackbar/show_snackbar.dart';
import 'package:bs_flutter_project_task/data/data_sources/local_keys.dart';
...
class UnauthorizedException extends CustomException {
  UnauthorizedException(
    this.customError,
    this.iFlutterNavigator,
    this.localStorageRepo,
  ) : super() {
